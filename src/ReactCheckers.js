...
export class ReactCheckers {
    ...
    getMoves(boardState, coordinates, hasJumped = false) {
    ...
    playerMove(coordinates, state) {
        ...
        if (jumpArray.indexOf(coordinates) > -1) {
            ...
            newMoves = this.getMoves(boardState, coordinates, true);
        ...
        stateOut.winner = this.haveWin(boardState);
    ...
    haveWin(boardState) {
        ...
        for (let coordinates in boardState) {
            ...
            const movesData = this.getMoves(boardState, coordinates, false);
